...
public class PhotoPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Media> paths = getIntent().getParcelableArrayListExtra(EXTRA_PHOTOS);
    ...
    public void onBackPressed() {
        ...
        intent.putExtra(KEY_SELECTED_PHOTOS, pagerFragment.getMedia());
        ...
        if (item.getItemId() == R.id.delete) {
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton(R.string.__picker_yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                pagerFragment.getMedia().remove(index);
            ...
            snackbar.setAction(R.string.__picker_undo, new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (pagerFragment.getMedia().size() > 0) {
                        pagerFragment.getMedia().add(index, deletedMedia);
                    } else {
                        pagerFragment.getMedia().add(deletedMedia);
                    }
                    pagerFragment.getViewPager().getAdapter().notifyDataSetChanged();
